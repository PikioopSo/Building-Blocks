...
var base =  
{
	...
	jScheme:
	  {
	  bin: ['id','class','name','title','is','style','jScheme'],
	  add: function(_jsn){},
	  update: function(_keyArray){}
	  },
  style:
    {
    bin: [],
...
var globalMixin = xtag.mixins.globalMixin =
  ...
  methods:
    ...
    elements: function()
      {
      /* creates new xml following json-tag rules. */
      }
    },
  lifecycle:
    {
...
var xForm = xtag.register( "json-form",
  ...
  lifecycle:
    ...
    inserted: function()
      ...
      this.contents("viewport",_formData);
      this.contents("mode",_formData);
      this.contents("scroll",_formData);
