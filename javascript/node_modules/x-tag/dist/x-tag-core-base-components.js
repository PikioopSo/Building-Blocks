...
/* Updates editor component information such as the focus, viewport, and container data. */
      ...
      if(_jsn.focus !== false)
        ...
        this.viewport = _jsn.viewport._getDOM();
        this.container = _jsn.container._getDOM();
    ...
    methods:
      ...
      getJson:
        function()
          ...
          else if(this.nodeName.toLowerCase !== "x-base"){ return xtag.tags["x-base"].modules[0].modules.getJsonById(this.id); }
          else
            {
            var _id = "", 
                _class = "";
...
/* Creates a new json for the x-tag element. */
          ...
          /x(?=\-)/.test(this.nodeName.toLowerCase()) === true ?
            _nodeName = this.nodeName.toLowerCase() : _nodeName = "x-" + this.nodeName.toLowerCase();

          if(xtag.tags[_nodeName].length === undefined){ xtag.tags[_nodeName].length = 0; }

          xtag.tags[_nodeName].modules = [];
          xtag.tags[_nodeName].modules.push(_jsn);

          base.json.push(_jsn);

          xtag.tags[_nodeName].length = xtag.tags[_nodeName].modules.length;
  ...
  xtag.register( "x-editor", 
    ...
    methods:
      ...
      createEditor: function()
        ...
        var _viewable_lines_ = _jsn.viewableLines,
            _viewed_lines_ = _jsn.viewedLines,
            _sheet_ = _jsn.sheet;
...
/* Find than update the editor object */
          var _jsn = xtag.tags["x-editor"].modules.getJsonById(this.id), 
            ...
            if(_jsn.focus===true)
              ...
              {
            editor.style.bin.push(base.style.createStyle(this,_jsn.style,_jsn));
              }
