    ...
    sheet: function(_style,_jsn)
      ...
      for(var _key in _style)
        ...
        if(typeof _style[_key]==="object")
          ...
          if(_key==="container")
            {
            _container = _jsn.container + "{" + this.write(_style[_key]) + "}"; 
            _style_sheet_ += _container;
            }
          else if(_key==="viewport")
            {
            _viewport = _jsn.viewport + "{" + this.write(_style[_key]) + "}"; 
            _style_sheet_ += _viewport;
            }
          else if(_key==="line")
            {
            _line = "x-line{" + this.write(_style[_key]) + "}"; 
            _style_sheet_ += _line;
            }
          else if(_key==="textCursor")
            {
            var _blink = _style[_key].blink||"1s",
                _width = _style[_key].width||"5px",
                _height = _style[_key].height||"16px;";
            var _keyframe = "@keyframes textCursorBlink{0%{opacity:1;}100%{opacity: .15;}}",
                _style_ = "#auto-textCurosr{animation-name:textCursorBlink;animation-duration:" + _blink + ";animation-iteration-count:infinite;animation-play-state:running;" + _width + ";height:" + _height + "}";
            _textCursor = _keyframe + _style_;
            _style_sheet_ += _textCursor;
            }
          else if(_key==="title")
            {
            _title = "x-title{" + this.write(_style[_key]) + "}";
            _style_sheet_ += _title;
            }
          else if(_key==="text")
            {
            _text = "x-text{" + this.write(_style[_key]) + "}";
            _style_sheet_ += _text;
            }
        ...
        else if(typeof _style[_key]==="string" && _key !== "type")
          {
          if(/[A-Z]/.test(_key))
            {
        ...
        else if(typeof _style[_key] === "array")
          {
            ...
            else if(/html/gi.test(_key))
              {
              
              }
            else if(/xml/gi.test(_key))
              {
...
var _style = document.createElement("style");
  ...
  _toJSON: String.prototype._toJSON = function(_array,_string)
    {
...
var globalMixin = xtag.mixins.globalMixin =
  ...
  methods:
    {
    render: function()
      {console.log(this.parentNode.nodeName);console.log(this.nodeName);
      var _jsn = this.getJson();
      document.body.appendChild(base.style.createStyle(this,_jsn.style,_jsn) );
      },
    getJson: function()
      {
...
var xBase = xtag.register( "json-base", 
    ...
    lifecycle: 
      ...
      created: 
        function()
          {
          /* Retrieves JSON from elements, adds/updates the modules property, and adds/updates the length property. */
...
var xMenu = xtag.register("json-menu",
  ...
  methods:
    {
    contents: function(_element,_def)
      {}
    },
  lifecycle:
    {
  ...
  /* [json-sheet] */
var xSheet = xtag.register("json-sheet",
  {
...
var xHeader = xtag.register( "json-header",
  ...
  content: function()
    {/*
    <json-menu name="header-nav-menu"></json-menu>
    <json-menu name="header-tools"></json-menu>
    */},
  methods:
    {
    contents: function(el,_json)
      {
      if(typeof _json === "object")
        {
        xtag.tags["json-base"].modules.push(_json);
        el.id = _json.id;
        el.className = _json.class;
        }
      }
    },
  lifecycle:
    ...
    created: function()
      {
      var _json = this.getJson();
      for(var key in _json)
        {
        if(key === "nav")
          {
          this.contents(this.getElementsByTagName("json-menu")[0],_json[key]);
          }
        else if (key === "tool")
          {
          this.contents(this.getElementsByTagName("json-menu")[1],_json[key]);
          }
        }
      this.render();
      }
...
var xCanvas = xtag.register( "json-canvas",
  ...
  methods:
    {
    contents: function(el,jsn)
      {
      el.id = jsn.id;
      el.className = jsn.class;
  ...
  lifecycle:
    ...
    created: function()
      {
      var _jsn = this.getJson();
      typeof _jsn.tool === "object" ? this.contents(this.getElementsByTagName("json-menu")[0],_jsn.tool) : null;
      this.render();
      }
    }
  } );
...
/* [json-form] */
  /* [json-form fragment] */
var formContents = xtag.createFragment( function()
  {/*
  <json-switch fieldset name="editor-scroll-direction" class="scroll-switch">
    <json-button class="form-switch"></json-button>
    <json-button class="form-switch></json-button>
    <json-button class="form-switch></json-button>
    <json-button class="form-switch"></json-button>
  </json-switch>
  <json-selector name="editor-mode-selector" class="selector-switch">
  <json-slider class="form-selector"></json-slider/>
    <json-polyline class="form-line"></json-polyline>
  </json-selector>
  <json-menu name="preference-menu" class="tool-menu">
    <json-field class="form-field"></json-field>
  </json-menu>
  <json-menu name="tool-menu" class="tool-menu">
    <json-field class="form-field"></json-field>
  </json-menu>
  <json-viewport name="editor-viewport" class="text-editor">
    <json-editor class="writer"></json-editor>
  </json-viewport>
  */} );
...
var formMixin = xtag.mixins.formMixin =
  ...
  methods:
    {
    contents: function(_key,_data)
      {
      switch(_key)
        {
        case "editor":
          xtag.tags["json-base"].modules.push(_data[_key]);
          this.getElementsByTagName("json-editor")[0].id = _data[_key].id;
          this.getElementsByTagName("json-editor")[0].className = _data[_key].id.class;
          editor.update(this,_data[_key]);
        return;
        case "preference":
          xtag.tags["json-base"].modules.push(_data[_key]);
          this.getElementsByTagName("json-menu")[0].id = _data[_key].id;
          this.getElementsByTagName("json-menu")[0].className = _data[_key].id.class;
        return;
        case "tool":
          xtag.tags["json-base"].modules.push(_data[_key]);
          this.getElementsByTagName("json-menu")[1].id = _data[_key].id;
          this.getElementsByTagName("json-menu")[1].className = _data[_key].id.class;
        return;
        case "viewport":
          this.getElementsByTagName("json-viewport")[0].id = _data[_key].id;
          this.getElementsByTagName("json-viewport")[0].className = _data[_key].id.class;
          xtag.tags["json-base"].modules.push(_data[_key]);
        return;
        case "scroll":
          xtag.tags["json-base"].modules.push(_data[_key]);
          this.getElementsByTagName("json-switch")[0].id = _data[_key].id;
          this.getElementsByTagName("json-switch")[0].className = _data[_key].id.class;
        return;
        case "mode":
          xtag.tags["json-base"].modules.push(_data[_key]);
          this.getElementsByTagName("json-selector")[0].id = _data[_key].id;
          this.getElementsByTagName("json-selector")[0].className = _data[_key].id.class;
        return;
        }
      }
    },
...
var xForm = xtag.register( "json-form",
  ...
  content: function()
    {/*
    <json-switch fieldset name="editor-scroll-direction" class="scroll-switch"></json-switch>
    <json-selector name="editor-mode-selector" class="selector-switch"></json-selector>
    <json-menu name="preference-menu" class="tool-menu"></json-menu>
    <json-menu name="tool-menu" class="tool-menu"></json-menu>
    <json-viewport name="editor-viewport" class="text-editor">
      <json-editor class="writer"></json-editor>
    </json-viewport>
    */},
  lifecycle:
    ...
    created: function()
      {
      this.render();
      var _formData = this.getJson();

      this.contents("preference",_formData);
      this.contents("tool",_formData);
      this.contents("editor",_formData);


      for(var _key in _formData)
        {
        if(typeof _formData[_key] === "object" && _key !== "style")
          {

          }
        else if (typeof _formData[_key] === "string")
          {
          }
        else if(_formData[_key] === null)
          {
          }
        }
...
var xViewport = xtag.register("json-viewport", 
  ...
  /* [json-toolbar] Registration */
var xToolBar = xtag.register("json-toolbar", 
  {
    ...
    methods:
      ...
      contents: function()
        ...
        for(var i in _sheet_)
          ...
          _line.innerHTML += "<x-text contenteditable ='true'>" + _sheet_[i] + "</x-text";
