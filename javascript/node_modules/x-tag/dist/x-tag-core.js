...
var make_component_modules = function make_component_modules(jsn){
  console.log(jsn);
};
...
var _modules = 
{
  ...
  toolbar: 
    ...
    make: function(jsn){  
      ...
      make_component_modules(jsn.modules);
  ...
  editor: 
    ...
    make: function(jsn){ make_component_modules(jsn) },
    getContent: function(jsn) { content(jsn) }
