...
function _searchFunc( search_param, comparison_param ){
...
function _searchArray( search_param, obj, _token ){
...
// [content] A function to read content objects.
var content = function content(jsn){

};

// [component] A function to read content objects.
var component = function component(jsn){
  console.log(jsn);
};
...
// The getJsonByTagName( search_param, obj, _token )
	Array.prototype.getJsonByTagName = function( search_param ){ _searchArray( search_param, this, "" ); };
	

// Notes: events object definition.
var _events = 
{
...
// Notes: _modules object definition.
var _modules = 
{
  ...
  toolbar: 
    ...
    getComponents: function(jsn){  

      return component(jsn.modules);

       },
    getContent: function(jsn){
  ...
  worktable: 
    ...
    getContent: function(jsn) { content(jsn) }
  ...
  editor: 
    ...
    getComponents: function(jsn){ component(jsn) },
    getContent: function(jsn) { content(jsn) }
...
// Notes: _components object definition.
var _components = 
{
  bin: [],
...
// Object prototypes.
// The _base() creates the components
	Object.prototype._base = function(){ 
var status = "";

// Find compatibility events first to ensure platform compatibility. Later I will add the event listeners to the module components as 
// part of the process for loading different interfaces...
    for( var y in this.compatibilitys ){

      for( var c in _events ){

        if( y.toString() === c.toString() && c.toString() !== "_base" && y.toString() !== "_base" ){
          console.log(c);
        }
        else{
    ...
    for( var x in this ){
      ...
      for( var i in _modules ){
        ...
        if( x.toString() === i.toString() && i.toString() !== "_base" && x.toString() !== "_base" ){

          _modules[i].getComponents(this[x]);
          _modules[i].getContent(this[x]);
...
var base = 
{
  ...
  status: function( _jsn ){

    _jsn === undefined ? _jsn = "JSON is" + _jsn : _jsn = "JSON has loaded";
...
var _jsonObject;
  ...
  _array = _array || base.json;
	_array.push( _jsonObject );
