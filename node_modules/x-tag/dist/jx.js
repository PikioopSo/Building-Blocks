  ...
  String.prototype._toJSON = function(_array,_string)
    ...
    try
      ...
      _string === true ?
        ...
        ( _obj = _jsonObject );console.log(_fixFinalComma)
    	return _obj;	
      }
    catch(e)
      {
...
var vault = 
  ...
  "prototype":
    ...
    type:{"object":function(fn){},"array":function(fn){},"string":function(fn){},"boolean":function(fn){},"number":function(fn){}, "null":function(fn){} },
    },
  sheet:
    {
    type:
...
var jx =  
  {
	...
	jScheme:
        ...
        for(var key in _data_)
          ...
          if(_type === "object")
            ...
            if(/style/.test(key) !== true && /sheet/.test(key) !== true)
              ...
              jx.json.push(_data); jx.jScheme.updateJxArray(_data);
              }
            else
              { null; }
            }
      ...
      for(var key in jsn)
        ...
        if(_type === "object")
          ...
          if(/style/.test(key) !== true && /sheet/.test(key) !== true)
            {
            _rt === "array" ? _data.for ? true : _data.for = "body[0]" : 
              jsn.for ? true :
                jsn.for = "#" + jsn.id;
    ...
    /* [addKeyLock] is for creating properties for the json container elements */
	  addKeyLock: function(elem,fn)
	    {
	    var data = base.json.getJsonById(elem.id);

	    var newObject = keyVault[data.id] = {};
	    },

    /* [createKeyLock] */
	  createKeyLock: function(keyJson,fn)
	    {
	    var _proto = vault["prototype"];
	      vault[keyJson.key] ? "Key lock already created." : vault[keyJson.key] = _proto;
        console.log(vault)
	    return _proto;
	    },
    ...
    checkKeyLock: function(key)
      ...
      for(var i=0; i < this.keyLocks.length; i++)
        {
        var _return = key === this.keyLocks[i] ? true : false;
        if(_return === true){ return true }
        }
      return false;
      }
...
/* Creates a stylesheet using a style tag and set attributes */
  ...
  jx.jScheme.createKeyLock( 
    {
    key:"sheet",
    obj:
      {
      style:
        {"position":"absolute","left":"0px","top":"0px","height":"100%","width":"100%","backgroundColor":"rgba(255,255,255)","cursor":"text","line":{"position":"relative","height":"25%","width":"100%","margin":"0px","padding":"0px","backgroundColor":"rgba(255,255,255,.5)","border":"none","opacity":"1","display":"block"},"title":{"position":"relative","top":"0%","left":"0%","height":"100%","width":"5%","border":"none","textAlign":"center","display":"block"},"text":{"position":"relative","left":"5%","top":"-100%","height":"100%","width":"94%","paddingLeft":"1%","backgroundColor":"rgba(200,200,255,.5)","border":"none","display":"block","fontFamily":"Lucida Console, Monaco, monospace","fontSize":"12px","color":"rgb(65,65,65)"}}
      } 
    }, 
    function()
      {
...
var schemeMixin = xtag.mixins.schemeMixin = 
  ...
  methods:
    ...
    /* [getKeyLock] */
    createKeyLock: function(doc,jsonElem)
      {
      // Check for the built in key lock props.
      if(jsonElem["sheet"])
        {
        var _doc = jsonElem["sheet"].for ? jsonElem["sheet"].for._getDOM() : doc;
        jx.jScheme.createKeyLock({key:'sheet',obj:jsonElem},function(){console.log("hello world")});
        this.jSheet(_doc,jsonElem["sheet"]);
        }
      if(jsonElem["draw"])
        {var _doc = jsonElem["draw"].for ? jsonElem["draw"].for._getDOM() : doc; this.jDraw(_doc,jsonElem["draw"])}
      if(jsonElem["style"])
        {var _doc = jsonElem["style"].for ? jsonElem["style"].for._getDOM() : doc; this.jStyle(_doc,jsonElem["style"])}
      if(jsonElem["animate"])
        {var _doc = jsonElem["animate"].for ? jsonElem["animate"].for._getDOM() : doc; this.jStyle(_doc,jsonElem["animate"])}
      },
...
var xBase = xtag.register( "json-base", 
    ...
    methods:
      ...
      updateJxArray: function(_data)
        {
        jx.jScheme.updateJxArray(_data);
        return;
        }
    ...
    lifecycle:
      ...
      created: function()
        ...
        for( var i=0; i<_modules.length; i++ )
          ...
          this.createKeyLock(doc,_modules[i]);
